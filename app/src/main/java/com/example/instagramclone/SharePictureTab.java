...
switch (view.getId()){
    ...
    case R.id.imgShare:
        ...
        //if the user hasn't given permission to external storage then request permission
    ...
    case R.id.btnShareImage:
        ...
        if(receivedImageBitmap != null){
            ...
            if (edtDescription.getText().toString().equals("")){
             ...
             //ByteArrayOutputStream is used to support for uploading an very large image
...
//        FancyToast.makeText(getContext(), "Now we can access the images", Toast.LENGTH_SHORT, FancyToast.SUCCESS, true).show();
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == 2000) {
            ...
            if (resultCode == Activity.RESULT_OK) {  //Activity.RESULT_OK means successfully get an image
